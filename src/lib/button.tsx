  ...
  (props, ref) => {
    ...
    return (
      <button
        ...
        className={twMerge(
          'flex items-center justify-center gap-1.5 rounded-lg outline-none transition-all duration-150 active:scale-95 disabled:cursor-not-allowed disabled:active:scale-100',
